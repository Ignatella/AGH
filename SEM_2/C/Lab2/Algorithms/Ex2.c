...
void fillArrayWithRands(int size, float arr[size]) {
    for (int i = 0; i < size; ++i) {
        arr[i] = randFloat();
    }
}

void revert(int size, float arr[size]) {
    float *s = arr;
    float *e = arr + size - 1;
...
void swapArrays(int size, float arr1[size], float arr2[size]) {
    for (int i = 0; i < size; ++i)
        swap(&arr1[i], &arr2[i]);
}

void mergeSortedArrays
        (int size1, const float arr1[size1], int size2, float const arr2[size2], float result[size1 + size2]) {
...
void revertBubbleSort(int size, float arr[size]) {
...
void bubbleSort(int size, float arr[size]) {
    for (int i = 0; i < size; ++i)
...
void insertionSort(int size, float arr[size]) {
...
void selectionSort(int size, float arr[size]) {

/* UWAGA
   ...
   * set - ustawiającą numer ID.
   ...
   Wskazówka: Należy zdefiniować funkcje statyczne w klasie albo zdefiniować funkcje w przestrzeni Vector.
   Tablica ma istnieć tylko jedna (może być typu void* rzutowana na T.

/*
 Celem zadania jest przećwiczenie funkcji wirtualnych i dzieddziczenia wielokrotnego. 
...
W ramach dokumentacji w pliku main.h proszę uzasadnić zastosowaną hierarchię, w tym też pliku może się też znależć się funkcja wspólna draw. Pozostałą strukturę plików pozostawiam Państwu do decyzji, jednak proszę nie pisać każdej klasy w osobnym pliku, lecz pogrupować je na np klasy abstrakcyjne (z funkcjami abstrakcyjnymi) i poszczególnych obiektów. 

/* Należy zdefiniować szablon klasy Array ze specjalizacją dla wskaźników.
   Specjalizacja wpływa na kilka aspektów działania tego szablonu.
   W szczególności na to, co robi destruktor szablonu Array (czy kasuje obiekty, czy nie). Zmieniaja sie takze operator[] i operator <<.
   ...
   Nie korzystamy z std::vector ani std::array, a tablica w klasie Array ma podaną przy deklaracji rozmiar.
 */

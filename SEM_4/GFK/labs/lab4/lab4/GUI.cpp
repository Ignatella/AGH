...
{
	this->SetSizeHints( wxSize( 600,497 ), wxDefaultSize );
	...
	WxPanel->Connect( wxEVT_LEFT_DOWN, wxMouseEventHandler( MyFrame1::WxPanel_LeftDown ), NULL, this );
	WxPanel->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( MyFrame1::WxPanel_LeftUp ), NULL, this );
	WxPanel->Connect( wxEVT_MOTION, wxMouseEventHandler( MyFrame1::WxPanel_Motion ), NULL, this );
	WxPanel->Connect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( MyFrame1::WxPanel_MouseWheel ), NULL, this );
...
MyFrame1::~MyFrame1()
{
	...
	WxPanel->Disconnect( wxEVT_LEFT_DOWN, wxMouseEventHandler( MyFrame1::WxPanel_LeftDown ), NULL, this );
	WxPanel->Disconnect( wxEVT_LEFT_UP, wxMouseEventHandler( MyFrame1::WxPanel_LeftUp ), NULL, this );
	WxPanel->Disconnect( wxEVT_MOTION, wxMouseEventHandler( MyFrame1::WxPanel_Motion ), NULL, this );
	WxPanel->Disconnect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( MyFrame1::WxPanel_MouseWheel ), NULL, this );

...
protected:
	...
	void WxPanel_MouseWheel(wxMouseEvent& event);
	void WxPanel_Motion(wxMouseEvent& event);
	void WxPanel_LeftDown(wxMouseEvent& event);
	void WxPanel_LeftUp(wxMouseEvent& event);

...
public:
	...
	MyFrame1(
		...
		const wxString& title = _("GFK Lab 07"), 
		const wxPoint& pos = wxDefaultPosition,
		const wxSize& size = wxSize(520, 650),
		long style = wxMINIMIZE_BOX | wxSYSTEM_MENU | wxCAPTION | wxCLOSE_BOX | wxCLIP_CHILDREN| wxTAB_TRAVERSAL);
